...
!function(e) {
    var t, a = {
        saveSelection: function() {
            e(this).data("editor").focus(),
            window.getSelection ? (sel = window.getSelection(),
            sel.getRangeAt && sel.rangeCount && e(this).data("currentRange", sel.getRangeAt(0))) : document.selection && document.selection.createRange ? e(this).data("currentRange", document.selection.createRange()) : e(this).data("currentRange", null)
        },
                ...
                if (window.getSelection) {
                    if (t)
                        ...
                        "html" == a) {
                            ...
                            i.innerHTML = t;
                            for (var l, o = document.createDocumentFragment(); l = i.firstChild; )
                                o.appendChild(l);
                            n.insertNode(o)
                        } else
                    ...
                    document.selection && n.select && (n.select(),
                    t && ("html" == a ? n.pasteHTML(t) : n.text = t))
        },
        restoreIESelection: function() {
            var t = e(this).data("currentRange");
            t && (window.getSelection ? (sel = window.getSelection(),
            sel.removeAllRanges(),
            sel.addRange(t)) : document.selection && t.select && t.select())
        },
            ...
            if (window.getSelection) {
                if ((a = window.getSelection()).getRangeAt && a.rangeCount) {
                    ...
                    if ("html" == t) {
                        ...
                        l.innerHTML = e;
                        for (var o, r = document.createDocumentFragment(); o = l.firstChild; )
                            r.appendChild(o);
                        n.insertNode(r)
                    } else
                        n.insertNode(i),
                        n.selectNode(i);
                    a.removeAllRanges(),
                    (n = n.cloneRange()).collapse(!1),
                    a.addRange(n)
                }
            } else
                document.selection && document.selection.createRange && ((n = document.selection.createRange()).pasteHTML(e),
                n.select())
        },
        imageWidget: function() {
            ...
            handleFileSelect = function(n) {
                for (var i, l = n.target.files, o = 0; i = l[o]; o++)
                    if (i.type.match("image.*") && i.name.match(/(?:gif|jpg|png|jpeg)$/)) {
                        ...
                        a.showMessage.apply(this, ["imgErrMsg_" + t, "Invalid file type"])
            }
            ;
            var s = e("<input/>", {
                type: "file",
            ...
            e("<button/>", {
                ...
                if ("" == n)
                    return a.showMessage.apply(this, ["imgErrMsg_" + t, "Please enter image url"]),
                    !1;
                var i = e("<li/>", {
                ...
                e("<img/>", {
                    ...
                    return a.showMessage.apply(this, ["imgErrMsg_" + t, "Invalid image url"]),
                    !1
                }).load(function() {
            ...
            return n.append(i).append(p),
            n
        },
        tableWidget: function(a) {
            var n = "_" + e(this).attr("id");
            return void 0 !== a && (n = "_" + t.attr("id") + "_Edt"),
            e("<div/>", {
                class: "row-fluid"
            }).append(e("<div/>", {
                id: "tblErrMsg" + n
        ...
        getHTMLTable: function(t, a, n) {
            for (var i = e("<table/>", {
                ...
                "" != n[l].value && ("width" == n[l].attribute || "height" == n[l].attribute ? i.css(n[l].attribute, n[l].value) : i.attr(n[l].attribute, n[l].value));
            for (l = 1; l <= t; l++) {
        ...
        init: function(n) {
              ...
              , o = {
                ...
                color: {
                    ...
                    custom: function(t) {
                        ...
                        if (n.data("colorBtn") ? (l = 1,
                        n.data("colorBtn", null)) : n.data("colorBtn", 1),
                        0 == l) {
                            for (var p = 0; p < i.length; p++)
                                null != i[p].hex ? (s.append(e("<li />").css("background-color", i[p].hex).mousedown(function(e) {
                                    e.preventDefault()
                                }).click(function() {
                                    var t = a.rgbToHex.apply(this, [e(this).css("background-color")]);
                                    a.restoreSelection.apply(this),
                                    a.setStyleWithCSS.apply(this),
                                    document.execCommand("forecolor", !1, t),
                                    e("#paletteCntr").remove(),
                                    n.data("colorBtn", null)
                                })),
                ...
                insert_link: {
                    ...
                    beforeLoad: function() {
                        ...
                        e("#inputUrl" + a),
                        e(".alert").alert("close"),
                        "" != e(t).data("currentRange") && e("#inputText_" + a).val(e(t).data("currentRange"))
                    },
                    onSave: function() {
                        var n = "_" + t.attr("id")
                          , i = e("#inputText" + n).val()
                        ...
                        if ("" == l)
                            return a.showMessage.apply(t, ["errMsg", "Please enter url"]),
                            !1;
                        if (!l.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/))
                            return a.showMessage.apply(t, ["errMsg", "Enter valid url"]),
                            !1;
                        if ("" == o && "" == i && (i = l),
                        navigator.userAgent.match(/MSIE/i) || navigator.userAgent.match(/Windows NT.*Trident\//)) {
                            var r = '<a href="' + l + '" target="_blank">' + i + "</a>";
                            a.restoreSelection.apply(t, [r, "html"])
                        } else
                            a.restoreSelection.apply(t, [i]),
                            document.execCommand("createLink", !1, l);
                        return e(t).data("editor").find('a[href="' + l + '"]').each(function() {
                            e(this).attr("target", "_blank")
                        }),
                        e(".alert").alert("close"),
                        e("#InsertLink" + n).modal("hide"),
                        e(t).data("editor").focus(),
                        !1
                    }
                },
                insert_img: {
                    ...
                    beforeLoad: function() {
                        ...
                        e("#imageURL_" + a).val(""),
                        e("#uploadImageBar_" + a + " :input").val(""),
                        e("#imageList_" + a).data("current", "")
                    },
                    onSave: function() {
                        var n = "_" + t.attr("id");
                        if (a.restoreSelection.apply(this),
                        !e("#imageList" + n).data("current"))
                            return a.showMessage.apply(this, ["imgErrMsg" + n, "Please select an image"]),
                            !1;
                        if (navigator.userAgent.match(/MSIE/i) || navigator.userAgent.match(/Windows NT.*Trident\//)) {
                            ...
                            document.execCommand("insertimage", !1, e("#imageList" + n).data("current"));
                        e("#InsertImage" + n).modal("hide"),
                        e(this).data("editor").focus()
                    }
                },
                insert_table: {
                    ...
                    onSave: function() {
                        ...
                        var n = e("#tblRows" + _idSuffix).val()
                          ...
                          , u = /^[0-9]+\.?([0-9])?$/;
                        if (!n.match(p))
                            return a.showMessage.apply(this, ["tblErrMsg", "Rows must be a positive number"]),
                            !1;
                        if (!i.match(p))
                            return a.showMessage.apply(this, ["tblErrMsg", "Columns must be a positive number"]),
                            !1;
                        if ("" != l && !l.match(m))
                            return a.showMessage.apply(this, ["tblErrMsg", "Please enter positive number with or without a valid CSS measurement unit (px,em,ex,%,in,cm,mm,pt,pc)"]),
                            !1;
                        if ("" != o && !o.match(m))
                            return a.showMessage.apply(this, ["tblErrMsg", "Please enter positive number with or without a valid CSS measurement unit (px,em,ex,%,in,cm,mm,pt,pc)"]),
                            !1;
                        if ("" != s && !s.match(u))
                            return a.showMessage.apply(this, ["tblErrMsg", "Border size must be a positive number"]),
                            !1;
                        if ("" != d && !d.match(u))
                            return a.showMessage.apply(this, ["tblErrMsg", "Cell spacing must be a positive number"]),
                            !1;
                        if ("" != c && !c.match(u))
                            return a.showMessage.apply(this, ["tblErrMsg", "Cell padding must be a positive number"]),
                            !1;
                        var h = e("<div/>")
                          , g = [{
                            attribute: "align",
                        ...
                        a.getHTMLTable.apply(this, [n, i, g]).appendTo(h),
                        navigator.userAgent.match(/MSIE/i) || navigator.userAgent.match(/Windows NT.*Trident\//) ? a.restoreSelection.apply(this, [h.html(), "html"]) : document.execCommand("insertHTML", !1, h.html()),
                        e("#InsertTable" + _idSuffix).modal("hide"),
                        e(this).data("editor").focus()
                    }
                },
                hr_line: {
                ...
                block_quote: {
                    ...
                    custom: function() {
                        a.setStyleWithCSS.apply(this),
                        navigator.userAgent.match(/MSIE/i) || navigator.userAgent.match(/Windows NT.*Trident\//) ? document.execCommand("indent", !1, null) : document.execCommand("formatBlock", !1, "<blockquote>")
                    }
                },
                indent: {
                    text: "Indent",
                ...
                print: {
                    ...
                    custom: function() {
                        ...
                        t.document.open(),
                        t.document.write('<!doctype html><html><head><title>Print</title></head><body onload="print();">' + oDoc.html() + "</body></html>"),
                        t.document.close()
                    }
                },
                rm_format: {
                ...
                togglescreen: {
                    ...
                    custom: function(t, a) {
                        ...
                        var n = 0;
                        e(this).data("statusBar").length && (n = e(this).data("statusBar").height()),
                        e(this).data("editor").parent().hasClass("fullscreen") ? e(this).data("editor").css({
                ...
                splchars: {
                    ...
                    custom: function(t) {
                        ...
                        var n = 0
                          ...
                          , r = this;
                        if (e(this).data("editor").data("splcharsBtn") ? (n = 1,
                        e(this).data("editor").data("splcharsBtn", null)) : e(this).data("editor").data("splcharsBtn", 1),
                        0 == n) {
                            for (var s = 0; s < l.length; s++)
                                o.append(e("<li />").html(l[s].text).attr("title", l[s].name).mousedown(function(e) {
                                    e.preventDefault()
                                }).click(function(t) {
                                    if (navigator.userAgent.match(/MSIE/i) || navigator.userAgent.match(/Windows NT.*Trident\//)) {
                                        var n = e(this).html();
                                        ...
                                        document.execCommand("insertHTML", !1, e(this).html());
                                    e("#specialchar").remove(),
                                    e(r).data("editor").data("splcharsBtn", null)
                                }));
                            o.prependTo(i),
                            i.insertAfter(t),
                            e("#specialchar").slideDown("slow")
                        } else
                            e("#specialchar").remove()
                    }
                },
            ...
            e(this).data("menuBar", c),
            e(this).data("editor", p),
            e(this).data("statusBar", m);
            var u = this;
            s.status_bar && p.keyup(function(t) {
                var n = a.getWordCount.apply(u)
                  , i = a.getCharCount.apply(u);
                e(u).data("statusBar").html('<div class="label">Words : ' + n + "</div>"),
                e(u).data("statusBar").append('<div class="label">Characters : ' + i + "</div>")
            });
            for (var h in o)
                if (s[h])
                    if (h in r) {
            ...
            e(document.body).mousedown(function(t) {
                var a = e(t.target);
                a.parents().andSelf().is("#context-menu") || e("#context-menu").remove(),
                a.parents().andSelf().is("#specialchar") || '<i class="fa fa-asterisk"></i>' == a.closest("a").html() || e("#specialchar").is(":visible") && (e(u).data("editor").data("splcharsBtn", null),
                e("#specialchar").remove()),
                a.parents().andSelf().is("#paletteCntr") || '<i class="fa fa-font"></i>' == a.closest("a").html() || e("#paletteCntr").is(":visible") && (e(u).data("editor").data("colorBtn", null),
                e("#paletteCntr").remove())
            }),
            p.bind("contextmenu", function(t) {
                ...
                t.preventDefault(),
                e(t.target).is("a") ? (a.createLinkContext.apply(this, [t, i]),
                i.appendTo(n),
                n.appendTo("body")) : e(t.target).is("td") || e(t.target).is("th") ? (a.createTableContext.apply(this, [t, i]),
                i.appendTo(n),
                n.appendTo("body")) : e(t.target).is("img") && (a.createImageContext.apply(this, [t, i]),
                i.appendTo(n),
                n.appendTo("body"))
            })
        },
        ...
        createImageContext: function(n, i) {
            ...
            a.createModal.apply(this, [l, "Image Attributes", o, function() {
                var n = e("#imgAlt").val()
                  , i = e("#imgTarget").val();
                if ("" == n)
                    return a.showMessage.apply(this, ["imageErrMsg", "Please enter image alternative text"]),
                    !1;
                if ("" != i && !i.match(/(http|ftp|https):\/\/[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/))
                    return a.showMessage.apply(this, ["imageErrMsg", "Please enter valid url"]),
                    !1;
                if ("" != e("#imgHidden").val()) {
                    var l = e("#imgHidden").val();
                    e("#" + l).attr("alt", n),
                    "" != i ? e("#wrap_" + l).length ? e("#wrap_" + l).attr("href", i) : e("#" + l).wrap(e("<a/>", {
                        id: "wrap_" + l,
                        href: i,
                        target: "_blank"
                    })) : e("#wrap_" + l).length && e("#" + l).unwrap()
                }
                e("#imgAttribute").modal("hide"),
                t.data("editor").focus()
            }
            ]);
            var r, s, d = e("<a/>", {
            ...
            function() {
                ...
                if (e("#imgAlt").val(e(r.target).closest("img").attr("alt")),
                e("#imgTarget").val(""),
                void 0 !== e(r.target).closest("img").attr("id")) {
                    var a = e(r.target).closest("img").attr("id");
                    e("#imgHidden").val(a),
                    e("#wrap_" + a).length ? e("#imgTarget").val(e("#wrap_" + a).attr("href")) : e("#imgTarget").val("")
                } else
                    e(r.target).closest("img").attr("id", "img_" + t),
                    e("#imgHidden").val("img_" + t)
            }
            ));
        ...
        createTableContext: function(n, i) {
            ...
            a.createModal.apply(this, [o, "Table Properties", r, function() {
                var i = e("#tblWidth" + l).val()
                  ...
                  , m = /^auto$|^[+-]?[0-9]+\.?([0-9]+)?(px|em|ex|%|in|cm|mm|pt|pc)?$/gi
                  , u = /^[0-9]+\.?([0-9])?$/;
                return "" != i && !i.match(m) || "" != r && !r.match(m) ? (a.showMessage.apply(this, ["tblErrMsgEdt", "Please enter positive number with or without a valid CSS measurement unit (px,em,ex,%,in,cm,mm,pt,pc)"]),
                !1) : "" == s || s.match(u) ? "" == c || c.match(u) ? "" == p || p.match(u) ? (e(n.target).closest("table").css("width", i),
                "" != r && e(n.target).closest("table").css("height", r),
                e(n.target).closest("table").attr("align", d),
                e(n.target).closest("table").attr("border", s),
                e(n.target).closest("table").attr("cellspacing", c),
                e(n.target).closest("table").attr("cellpadding", p),
                e("#" + o).modal("hide"),
                void t.data("editor").focus()) : (a.showMessage.apply(this, ["tblErrMsgEdt", "Cell padding must be a positive number"]),
                !1) : (a.showMessage.apply(this, ["tblErrMsgEdt", "Cell spacing must be a positive number"]),
                !1) : (a.showMessage.apply(this, ["tblErrMsgEdt", "Border size must be a positive number"]),
                !1)
            }
            ]);
            ...
            function() {
                ...
                e("#context-menu").remove(),
                e("#tblRows" + a).val(e(s.target).closest("table").prop("rows").length),
                e("#tblColumns" + a).val(e(s.target).closest("table").find("tr")[0].cells.length),
                e("#tblRows" + a).attr("disabled", "disabled"),
                e("#tblColumns" + a).attr("disabled", "disabled"),
                e("#tblWidth" + a).val(e(s.target).closest("table").get(0).style.width),
                e("#tblHeight" + a).val(e(s.target).closest("table").get(0).style.height),
                e("#tblAlign" + a).val(e(s.target).closest("table").attr("align")),
                e("#tblBorder" + a).val(e(s.target).closest("table").attr("border")),
                e("#tblCellspacing" + a).val(e(s.target).closest("table").attr("cellspacing")),
                e("#tblCellpadding" + a).val(e(s.target).closest("table").attr("cellpadding"))
            }
            ));
            i.append(e("<li/>", {
            ...
            function() {
                e("#context-menu").remove(),
                e(u.target).closest("table").remove()
            }
            ))))
        },
        ...
        createMenuItem: function(t, n, i) {
            if (t.select) {
                ...
                e.each(n, function(t, a) {
                    ...
                    n.click(function() {
                        e(this).parent().parent().data("value", a),
                        e(this).parent().parent().trigger("change")
                    }),
                    o.append(n)
                });
                var r = "change"
                ...
                if (t.modal) {
                    l = a.createModal.apply(this, [t.modalId, t.modalHeader, t.modalBody, t.onSave]),
                    o = e("<i/>");
                    return t.icon ? o.addClass(t.icon) : o.html(t.text),
                    l.append(o),
                    l.mousedown((s = this,
                    d = a,
                    c = t.beforeLoad,
            ...
            var s, d, c, p, m;
            if (t.custom ? l.bind(r, (p = this,
            m = t.params,
            function() {
                a.saveSelection.apply(p),
                t.custom.apply(p, [e(this), m])
            }
            )) : (l.data("commandName", t.commandname),
            l.data("editor", e(this).data("editor")),
            l.bind(r, function() {
        ...
        setTextFormat: function() {
            return a.setStyleWithCSS.apply(this),
            document.execCommand(e(this).data("commandName"), !1, e(this).data("value") || null),
            e(this).data("editor").focus(),
            !1
        },
        getSource: function(t, a) {
            var n = 0;
            t.data("state") ? (n = 1,
            t.data("state", null)) : t.data("state", 1),
            e(this).data("source-mode", !n);
            var i, l = e(this).data("editor");
            if (0 == n)
                i = document.createTextNode(l.html()),
                l.empty(),
                l.attr("contenteditable", !1),
                preElement = e("<pre/>", {
                    contenteditable: !0
                }),
                preElement.append(i),
        ...
        showMessage: function(t, a) {
            e("<div/>", {
                ...
                "data-dismiss": "alert",
                html: "x"
            })).append(e("<span/>").html(a)).appendTo(e("#" + t)),
            setTimeout(function() {
                e(".alert").alert("close")
            }, 3e3)
        },
...
!function(i) {
    ...
    function o(i) {
        ...
        !i.data("minicolors-initialized") || i.prop("disabled") || t.hasClass("minicolors-inline") || t.hasClass("minicolors-focus") || (s(),
    ...
    function s() {
        i(".minicolors-focus").each(function() {
            ...
            s.fadeOut(a.hideSpeed, function() {
                a.hide && a.hide.call(o.get(0)),
                t.removeClass("minicolors-focus")
            })
        })
    }
    function a(i, t, o) {
        var s, a, r, e, c = i.parents(".minicolors").find(".minicolors-input"), l = c.data("minicolors-settings"), h = i.find("[class$=-picker]"), d = i.offset().left, p = i.offset().top, u = Math.round(t.pageX - d), g = Math.round(t.pageY - p), m = o ? l.animationSpeed : 0;
        ...
        i.parent().is(".minicolors-slider-wheel") && h.parent().is(".minicolors-grid") && (s = 75 - u,
        a = 75 - g,
        r = Math.sqrt(s * s + a * a),
    ...
    function n(i, t) {
        ...
        var s, a, n, e, l, h, d, p = i.val(), g = i.attr("data-opacity"), m = i.parent(), f = i.data("minicolors-settings"), v = m.find(".minicolors-input-swatch"), w = m.find(".minicolors-grid"), y = m.find(".minicolors-slider"), C = m.find(".minicolors-opacity-slider"), k = w.find("[class$=-picker]"), M = y.find("[class$=-picker]"), x = C.find("[class$=-picker]"), I = o(k, w), S = o(M, y), z = o(x, C);
        if (t.is(".minicolors-grid, .minicolors-slider, .minicolors-opacity-slider")) {
            ...
            case "wheel":
                ...
                l = w.height() / 2 - I.y,
                h = Math.sqrt(e * e + l * l),
                (d = Math.atan2(l, e)) < 0 && (d += 2 * Math.PI),
                h > 75 && (h = 75,
    ...
    function r(i, t, o) {
        ...
        "rgb" === n.format ? (s = g(t) ? d(t, !0) : w(h(t, !0)),
        o = "" === i.attr("data-opacity") ? 1 : u(parseFloat(i.attr("data-opacity")).toFixed(2), 0, 1),
        !isNaN(o) && n.opacity || (o = 1),
        t = i.minicolors("rgbObject").a <= 1 && s && n.opacity ? "rgba(" + s.r + ", " + s.g + ", " + s.b + ", " + parseFloat(o) + ")" : "rgb(" + s.r + ", " + s.g + ", " + s.b + ")") : (g(t) && (t = f(t)),
        t = l(t, n.letterCase)),
        i.val(t),
        r.find("span").css({
            backgroundColor: t,
    ...
    function e(t, o) {
        var s, a, n, r, e, v, y, C, k, M, x = t.parent(), I = t.data("minicolors-settings"), S = x.find(".minicolors-input-swatch"), z = x.find(".minicolors-grid"), F = x.find(".minicolors-slider"), T = x.find(".minicolors-opacity-slider"), D = z.find("[class$=-picker]"), j = F.find("[class$=-picker]"), q = T.find("[class$=-picker]");
        switch (g(t.val()) ? (s = f(t.val()),
        (e = u(parseFloat(m(t.val())).toFixed(2), 0, 1)) && t.attr("data-opacity", e)) : s = l(h(t.val(), !0), I.letterCase),
        s || (s = l(p(I.defaultValue, !0), I.letterCase)),
        a = function(i) {
            var t = function(i) {
                var t = {
                    h: 0,
        ...
        r = I.keywords ? i.map(I.keywords.split(","), function(t) {
            return i.trim(t.toLowerCase())
        }) : [],
        v = "" !== t.val() && i.inArray(t.val().toLowerCase(), r) > -1 ? l(t.val()) : g(t.val()) ? d(t.val()) : s,
        o || t.val(v),
        I.opacity && (n = "" === t.attr("data-opacity") ? 1 : u(parseFloat(t.attr("data-opacity")).toFixed(2), 0, 1),
        isNaN(n) && (n = 1),
        t.attr("data-opacity", n),
        S.find("span").css("opacity", n),
        C = u(T.height() - T.height() * n, 0, T.height()),
        q.css("top", C + "px")),
        "transparent" === t.val().toLowerCase() && S.find("span").css("opacity", 0),
        S.find("span").css("backgroundColor", s),
        I.control) {
        case "wheel":
            k = u(Math.ceil(.75 * a.s), 0, z.height() / 2),
            M = a.h * Math.PI / 180,
            y = u(75 - Math.cos(M) * k, 0, z.width()),
            C = u(75 - Math.sin(M) * k, 0, z.height()),
            D.css({
                top: C + "px",
                left: y + "px"
            }),
            C = 150 - a.b / (100 / z.height()),
            "" === s && (C = 0),
            j.css("top", C + "px"),
        ...
        case "saturation":
            y = u(5 * a.h / 12, 0, 150),
            C = u(z.height() - Math.ceil(a.b / (100 / z.height())), 0, z.height()),
            D.css({
                top: C + "px",
                left: y + "px"
            }),
            C = u(F.height() - a.s * (F.height() / 100), 0, F.height()),
            j.css("top", C + "px"),
            F.css("backgroundColor", b({
                h: a.h,
                s: 100,
        ...
        case "brightness":
            y = u(5 * a.h / 12, 0, 150),
            C = u(z.height() - Math.ceil(a.s / (100 / z.height())), 0, z.height()),
            D.css({
                top: C + "px",
                left: y + "px"
            }),
            C = u(F.height() - a.b * (F.height() / 100), 0, F.height()),
            j.css("top", C + "px"),
            F.css("backgroundColor", b({
                h: a.h,
                s: a.s,
            ...
            break;
        default:
            y = u(Math.ceil(a.s / (100 / z.width())), 0, z.width()),
            C = u(z.height() - Math.ceil(a.b / (100 / z.height())), 0, z.height()),
            D.css({
                top: C + "px",
                left: y + "px"
            }),
            C = u(F.height() - a.h / (360 / F.height()), 0, F.height()),
            j.css("top", C + "px"),
            z.css("backgroundColor", b({
                h: a.h,
                s: 100,
                b: 100
            }))
    ...
    function c(i, t, o) {
        ...
        if (!e || e.value !== t || e.opacity !== o) {
            ...
            }, r.changeDelay))) : r.change.call(i.get(0), t, o)),
    ...
    function d(i, t) {
        ...
        return o[0] = u(parseInt(o[0], 10), 0, 255),
        o[1] = u(parseInt(o[1], 10), 0, 255),
        o[2] = u(parseInt(o[2], 10), 0, 255),
        o[3] && (o[3] = u(parseFloat(o[3], 10), 0, 1)),
        t ? o[3] ? {
            r: o[0],
            g: o[1],
            b: o[2],
        ...
        minicolors: function(a, n) {
            ...
            case "settings":
                return void 0 === n ? i(this).data("minicolors-settings") : (i(this).each(function() {
                    ...
                    t(i(this)),
                    i(this).minicolors(i.extend(!0, o, n))
                }),
                i(this));
            case "show":
                return o(i(this).eq(0)),
                i(this);
            case "value":
                return void 0 === n ? i(this).val() : (i(this).each(function() {
                    "object" == typeof n && "null" !== n ? (n.opacity && i(this).attr("data-opacity", u(n.opacity, 0, 1)),
                    n.color && i(this).val(n.color)) : i(this).val(n),
                    e(i(this))
                }),
                i(this));
            default:
                ...
                i(this).each(function() {
                    !function(t, o) {
                        var s, a, n, r, c, l = i('<div class="minicolors" />'), p = i.minicolors.defaults;
                        if (t.data("minicolors-initialized"))
                            return;
                        o = i.extend(!0, {}, p, o),
                        l.addClass("minicolors-theme-" + o.theme).toggleClass("minicolors-with-opacity", o.opacity),
                        ...
                        o.swatches && 0 !== o.swatches.length)
                            for (r.addClass("minicolors-with-swatches"),
                            a = i('<ul class="minicolors-swatches"></ul>').appendTo(r),
                            c = 0; c < o.swatches.length; ++c)
                                n = g(n = o.swatches[c]) ? d(n, !0) : w(h(n, !0)),
                                i('<li class="minicolors-swatch minicolors-sprite"><span class="minicolors-swatch-color"></span></li>').appendTo(a).data("swatch-color", o.swatches[c]).find(".minicolors-swatch-color").css({
                                    backgroundColor: v(n),
                                    opacity: n.a
                                }),
                                o.swatches[c] = n;
    ...
    i([document]).on("mousedown.minicolors touchstart.minicolors", function(t) {
        ...
        n = "" !== r.val() && i.inArray(r.val().toLowerCase(), t) > -1 ? r.val() : null === (s = g(r.val()) ? d(r.val(), !0) : (o = h(r.val(), !0)) ? w(o) : null) ? e.defaultValue : "rgb" === e.format ? e.opacity ? d("rgba(" + s.r + "," + s.g + "," + s.b + "," + r.attr("data-opacity") + ")") : d("rgb(" + s.r + "," + s.g + "," + s.b + ")") : v(s),
        a = e.opacity ? r.attr("data-opacity") : 1,
        "transparent" === n.toLowerCase() && (a = 0),
        r.closest(".minicolors").find(".minicolors-input-swatch > span").css("opacity", a),
        r.val(n),
        "" === r.val() && r.val(p(e.defaultValue, !0)),
        r.val(l(r.val(), e.letterCase)))
...
!function(e, t) {
    ...
    var t, n, i, o = ["Webkit", "Moz", "ms"], r = document.createElement("div").style, a = [1, 8, 3, 6], s = [2, 7, 4, 5];
    function l(e) {
        if (e in r)
            return e;
    ...
    w.parse = function(e) {
        return e.style ? w.parse(e.style[n]) : e.indexOf("matrix") > -1 || e.indexOf("none") > -1 ? w.fromMatrix(e) : w.fromString(e)
    }
    ,
    w.fromMatrix = function(e) {
        var t = e.substring(7).split(",");
        return t.length && "none" !== e || (t = [1, 0, 0, 1, 0, 0]),
        new w(f(t[4]),f(t[5]),parseFloat(t[0]))
    }
    ,
    w.fromString = function(e) {
        var t = e.split(") ")
          , n = t[0].substring(q.globals.translate.length + 1).split(",")
    ...
    function C() {
        ...
        this.options.useCanvas = this.options.enableOrientation || E.call(this),
        this.data = {},
        this.elements = {},
        e = this.elements.boundary = document.createElement("div"),
        t = this.elements.viewport = document.createElement("div"),
        this.elements.img = document.createElement("img"),
        o = this.elements.overlay = document.createElement("div"),
        this.options.useCanvas ? (this.elements.canvas = document.createElement("canvas"),
        this.elements.preview = this.elements.canvas) : this.elements.preview = this.elements.img,
        d(e, "cr-boundary"),
        e.setAttribute("aria-dropeffect", "none"),
        r = this.options.boundary.width,
        a = this.options.boundary.height,
        p(e, {
            width: r + (isNaN(r) ? "" : "px"),
            height: a + (isNaN(a) ? "" : "px")
        }),
        ...
        d(this.elements.preview, "cr-image"),
        m(this.elements.preview, {
            alt: "preview",
            "aria-grabbed": "false"
        }),
        d(o, "cr-overlay"),
        this.element.appendChild(e),
        e.appendChild(this.elements.preview),
        e.appendChild(t),
        e.appendChild(o),
        d(this.element, "croppie-container"),
        this.options.customClass && d(this.element, this.options.customClass),
        function() {
            var e, t, o, r, a, s = this, l = !1;
            function h(e, t) {
                var n = s.elements.preview.getBoundingClientRect()
                  , i = a.y + t
                  , o = a.x + e;
                s.options.enforceBoundary ? (r.top > n.top + t && r.bottom < n.bottom + t && (a.y = i),
                r.left > n.left + e && r.right < n.right + e && (a.x = o)) : (a.y = i,
                a.x = o)
            }
            function u(e) {
            ...
            function d(n) {
                if ((void 0 === n.button || 0 === n.button) && (n.preventDefault(),
                !l)) {
                    if (l = !0,
                    e = n.pageX,
                    t = n.pageY,
            ...
            function m(i) {
                ...
                if ("touchmove" === i.type && i.touches.length > 1) {
                    ...
                    var y = w / o;
                    return L.call(s, y),
                    void c(s.elements.zoomer)
                }
                h(d, m),
                f[n] = a.toString(),
                p(s.elements.preview, f),
                R.call(s),
                t = l,
                e = r
            }
            ...
            s.elements.overlay.addEventListener("mousedown", d),
            s.elements.viewport.addEventListener("keydown", function(e) {
                ...
                if (!e.shiftKey || e.keyCode !== l && e.keyCode !== c) {
                    ...
                    var m = 0;
                    m = e.keyCode === l ? parseFloat(s.elements.zoomer.value, 10) + parseFloat(s.elements.zoomer.step, 10) : parseFloat(s.elements.zoomer.value, 10) - parseFloat(s.elements.zoomer.step, 10),
                    s.setZoom(m)
                }
            }),
        ...
        .call(this),
        this.options.enableZoom && function() {
            var e = this
            ...
            t.appendChild(n),
            e._currentZoom = 1,
            e.elements.zoomer.addEventListener("input", i),
            e.elements.zoomer.addEventListener("change", i),
            e.options.mouseWheelZoom && (e.elements.boundary.addEventListener("mousewheel", o),
            e.elements.boundary.addEventListener("DOMMouseScroll", o))
        }
        .call(this),
        this.options.enableResize && function() {
            var e, t, n, o, r, a, s, l = this, h = document.createElement("div"), u = !1, c = 50;
            d(h, "cr-resizer"),
            p(h, {
                width: this.options.viewport.width + "px",
                height: this.options.viewport.height + "px"
            }),
            this.options.resizeControls.height && (d(a = document.createElement("div"), "cr-resizer-vertical"),
            h.appendChild(a));
            this.options.resizeControls.width && (d(s = document.createElement("div"), "cr-resizer-horisontal"),
            h.appendChild(s));
            function m(a) {
                if ((void 0 === a.button || 0 === a.button) && (a.preventDefault(),
                !u)) {
    ...
    function _(e) {
        var i = this
          ...
          , r = e ? e.viewportRect : i.elements.viewport.getBoundingClientRect()
          , a = e ? e.origin : new y(i.elements.preview);
        function s() {
            var e = {};
            e[n] = o.toString(),
            e[t] = a.toString(),
            p(i.elements.preview, e)
        }
        if (i._currentZoom = e ? e.value : i._currentZoom,
        o.scale = i._currentZoom,
        ...
        i.options.enforceBoundary) {
            ...
            .call(i, r)
              , h = l.translate
              , u = l.origin;
            o.x >= h.maxX && (a.x = u.minX,
            o.x = h.maxX),
            o.x <= h.minX && (a.x = u.maxX,
            o.x = h.minX),
            o.y >= h.maxY && (a.y = u.minY,
            o.y = h.maxY),
            o.y <= h.minY && (a.y = u.maxY,
            o.y = h.minY)
        }
        s(),
        X.call(i),
    ...
    function B() {
        var e = this._currentZoom
          , i = this.elements.preview.getBoundingClientRect()
          , o = this.elements.viewport.getBoundingClientRect()
          , r = w.parse(this.elements.preview.style[n])
    ...
    function Y() {
        var e, t = this.get();
        F.call(this) && (this.options.update.call(this, t),
        this.$ && "undefined" == typeof Prototype ? this.$(this.element).trigger("update.croppie", t) : (window.CustomEvent ? e = new CustomEvent("update",{
            detail: t
        }) : (e = document.createEvent("CustomEvent")).initCustomEvent("update", !0, !0, t),
    ...
    function W() {
        var e, i = {}, o = this.elements.preview, r = new w(0,0,1), a = new y;
        F.call(this) && !this.data.bound && (this.data.bound = !0,
        i[n] = r.toString(),
        i[t] = a.toString(),
        i.opacity = 1,
        p(o, i),
        e = this.elements.preview.getBoundingClientRect(),
        this._originalImageWidth = e.width,
        this._originalImageHeight = e.height,
        this.data.orientation = b(this.elements.img),
        this.options.enableZoom ? k.call(this, !0) : this._currentZoom = 1,
        r.scale = this._currentZoom,
        i[n] = r.toString(),
        p(o, i),
        this.data.points.length ? function(e) {
            if (4 !== e.length)
            ...
            var i = e[2] - e[0]
              ...
              , d = {};
            d[t] = h + "px " + l + "px",
            d[n] = new w(c,u,s).toString(),
            p(this.elements.preview, d),
            L.call(this, s),
            this._currentZoom = s
        }
        .call(this, this.data.points) : function() {
            ...
            p(this.elements.preview, n, l.toString())
        }
        .call(this),
        B.call(this),
        R.call(this))
    ...
    function k(e) {
        var t, n, i, o, r = 0, a = this.options.maxZoom || 1.5, s = this.elements.zoomer, l = parseFloat(s.value), h = this.elements.boundary.getBoundingClientRect(), u = v(this.elements.img, this.data.orientation), p = this.elements.viewport.getBoundingClientRect();
        this.options.enforceBoundary && (i = p.width / u.width,
        o = p.height / u.height,
        r = Math.max(i, o)),
        r >= a && (a = r + 1),
        s.min = j(r, 4),
        s.max = j(a, 4),
        !e && (l < s.min || l > s.max) ? L.call(this, l < s.min ? s.min : s.max) : e && (n = Math.max(h.width / u.width, h.height / u.height),
        t = null !== this.data.boundZoom ? this.data.boundZoom : n,
        L.call(this, t)),
        c(s)
    }
    function A(e) {
        ...
        return s.width = h,
        s.height = u,
        e.backgroundColor && (l.fillStyle = e.backgroundColor,
        l.fillRect(0, 0, h, u)),
        !1 !== this.options.enforceBoundary && (o = Math.min(o, this._originalImageWidth),
        r = Math.min(r, this._originalImageHeight)),
        l.drawImage(this.elements.preview, n, i, o, r, 0, 0, h, u),
        a && (l.fillStyle = "#fff",
        l.globalCompositeOperation = "destination-in",
        l.beginPath(),
        l.arc(s.width / 2, s.height / 2, s.width / 2, 0, 2 * Math.PI, !0),
        l.closePath(),
        l.fill()),
        s
    }
    function O(e, t) {
        var n, i, o, r, a = this, s = [], l = null, h = E.call(a);
        if ("string" == typeof e)
            n = e,
            e = {};
        ...
        return a.data.bound = !1,
        a.data.url = n || a.data.url,
        a.data.boundZoom = l,
        (i = n,
        o = h,
        r = new Image,
        ...
        new Promise(function(e) {
            ...
            i.match(/^https?:\/\/|^\/\//) && r.setAttribute("crossOrigin", "anonymous"),
            r.onload = function() {
            ...
            .call(a, n),
            s.length)
                a.options.relative && (s = [s[0] * n.naturalWidth / 100, s[1] * n.naturalHeight / 100, s[2] * n.naturalWidth / 100, s[3] * n.naturalHeight / 100]);
            else {
                var i, o, r = v(n), l = a.elements.viewport.getBoundingClientRect(), h = l.width / l.height;
                r.width / r.height > h ? i = (o = r.height) * h : (i = r.width,
                o = r.height / h);
                var u = (r.width - i) / 2
                  , c = (r.height - o) / 2
                  , p = u + i
            ...
            a.options.useCanvas && function(e) {
                ...
                t.width = n.width,
                t.height = n.height,
                o && !e ? x(t, n, f(b(n) || 0)) : e && x(t, n, e)
            }
            .call(a, e.orientation || 1),
            W.call(a),
            Y.call(a),
            t && t()
        }).catch(function(e) {
    ...
    function H() {
        var e = this.elements.preview.getBoundingClientRect()
          ...
          , s = i + this.elements.viewport.offsetHeight + r
          , l = this._currentZoom;
        (l === 1 / 0 || isNaN(l)) && (l = 1);
        var h = this.options.enforceBoundary ? 0 : Number.NEGATIVE_INFINITY;
        return n = Math.max(h, n / l),
        i = Math.max(h, i / l),
        a = Math.max(h, a / l),
        s = Math.max(h, s / l),
        {
            points: [j(n), j(i), j(a), j(s)],
            zoom: l,
    ...
    function P(e) {
        var t = this
          ...
          , s = i.quality
          , l = i.backgroundColor
          , c = "boolean" == typeof i.circle ? i.circle : "circle" === t.options.viewport.type
          , m = t.elements.viewport.getBoundingClientRect()
          , f = m.width / m.height;
        return "viewport" === r ? (n.outputWidth = m.width,
        n.outputHeight = m.height) : "object" == typeof r && (r.width && r.height ? (n.outputWidth = r.width,
        n.outputHeight = r.height) : r.width ? (n.outputWidth = r.width,
        n.outputHeight = r.width / f) : r.height && (n.outputWidth = r.height * f,
        n.outputHeight = r.height)),
        S.indexOf(a) > -1 && (n.format = "image/" + a,
        n.quality = s),
        n.circle = c,
        n.url = t.data.url,
        n.backgroundColor = l,
        new Promise(function(e, i) {
            ...
            case "base64":
                e(function(e) {
                    return A.call(this, e).toDataURL(e.format, e.quality)
                }
                .call(t, n));
                break;
            case "blob":
    ...
    function D(e) {
        ...
        var t = this.elements.canvas;
        this.data.orientation = function(e, t) {
            var n = a.indexOf(e) > -1 ? a : s
              , i = n.indexOf(e)
              , o = t / 90 % n.length;
            return n[(n.length + i + o % n.length) % n.length]
        }(this.data.orientation, e),
        x(t, this.elements.img, this.data.orientation),
        k.call(this),
        _.call(this),
        copy = null
    }
    ...
    function q(e, t) {
        ...
        if (this.element = e,
        this.options = h(u(q.defaults), t),
        "img" === this.element.tagName.toLowerCase()) {
            var n = this.element;
            d(n, "cr-original-image"),
            m(n, {
                "aria-hidden": "true",
                alt: ""
            });
