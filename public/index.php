...
|--------------------------------------------------------------------------
|
| If the application is in maintenance or demo mode, we will load this
| file so that any pre-rendered content can be shown instead of starting
| the framework, which could cause an exception.
|
*/
